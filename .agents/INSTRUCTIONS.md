...
| **market-analysis** | 市場規模・成長率・市場構造・参入障壁を調査する | 市場の全体像を数字で把握したい時、TAM/SAM/SOMを出したい時 |
| **market-research** | Web検索とブラウザ操作を活用し、競合分析・法規制・価格調査を段階的に実施する | 競合分析、法規制調査、価格調査が必要な時 |
